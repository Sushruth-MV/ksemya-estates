...
const socialLinks = [
  {
    name: "Instagram",
    href: "https://www.instagram.com/ksemyaestates?igsh=bXkwaTB0ZnQyamI5",
    icon: (
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/profile.php?id=61592436562623",
    icon: (
  ...
  {
    name: "YouTube",
    href: "https://www.youtube.com/@KsemyaEstates",
    icon: (
      ...
      <div className="max-w-6xl mx-auto px-5 md:px-8 py-16 grid grid-cols-1 md:grid-cols-[auto_1fr_1fr] gap-12">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-cream/70">
            ...
            <li>
              <Link href="/contact" className="link-underline hover:text-cream transition-colors">
                Contact Us
              </Link>
            </li>
            <li>
